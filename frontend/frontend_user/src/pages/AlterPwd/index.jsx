...
import "./index.css"
import bgimg from "./../../images/key.jpg"
class AlterPwd extends Component {
    ...
    render () {
        ...
        if(username === undefined){
            ...
            return (
                <div style={{display:'flex', justifyContent:'center' ,backgroundColor:'#656467',height:'70%'}}>
                    {/*<img src={bgimg}   width={400} height={300}/>*/}
                    <Card title="修改密码" bordered={false} style={{ width: '50%' ,height:'80%', top:"10%"}} headStyle={{display:'flex', justifyContent:'center'}}>
