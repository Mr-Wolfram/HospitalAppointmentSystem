...
class Registration extends React.Component {
    ...
    async changeDoctorId(){
        await this.setState({doctorId:"2122"});
        //要被阻塞的,比如console.log doctorID的新值
        console.log("这里可以做改完state之后的事情")
    }
    componentWillMount() {

        this.changeDoctorId().then(
            r=>{
                console.log("这里可以做改完state之后的事情")
            }
        )
        console.log("这里可以做不被doctorID影响的值,如你想打印未刷新的doctorId旧值")
